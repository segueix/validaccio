...
| Situació | Funcions |
|---|---|
| **FET** | 001, 002, 003, 004, 006, 007, 009, 010, 101, 102, 103, 104, 105, 107, 201, 204, 205, 206, 209, 301, 302, 303 i 502 |
| **EN CURS** | — |
| **PARCIAL** | 005, 008, 501, 503 i 505 |
| **SEGÜENT BLOC FUNCIONAL** | 304 → 305: versions i perfil d’estil de l’autor |
...
(101 → 102 → 103 → 105) ja estan completats. El bloc de fonts es tanca amb el
**visor PDF (104)** i els **extractes citables (107)**, tots dos verificats
end-to-end. El pas natural següent és **108 → 110** (qualitat i límits de la
font, cerca de corpus) i, tot seguit, el nucli metodològic ACH (201…).
