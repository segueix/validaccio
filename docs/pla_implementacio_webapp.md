...
| **002** | Repositori local versionat | P0 | 001 | **PARCIAL** | IndexedDB amb esquema explícit, transaccions, repositoris tipats i versió de dades; la base actual només desa metadades bàsiques. |
