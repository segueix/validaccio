...
const moduleCopy: Record<Exclude<ViewId, "tauler" | "salut" | "privadesa" | "fonts" | "hipotesis">, { eyebrow: string; title: string; body: string; status: string }> = {
  evidencies: {
    eyebrow: "Fase 2",
...
function ModuleView({
  ...
  view: Exclude<ViewId, "tauler" | "salut" | "privadesa" | "fonts" | "hipotesis">;
  project: Project;
  onExport: () => void;
  onImport: () => void;
}) {
